...
public class XACMLtranslation_Test extends AbstractXtextTests {
  ...
  public void checkObl() {
    try {
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("[permit M mail(cat/id)]");
      _builder.newLine();
      _builder.append("}");
      Facpl model = this._parseHelper.parse(_builder);
      ...
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("obl: ");
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("[permit M mail(cat/id, true, 5, addition(4,5))]");
      _builder_1.newLine();
      _builder_1.append("}");
      Facpl _parse = this._parseHelper.parse(_builder_1);
      model = _parse;
      ...
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("obl: ");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("[permit M mail(cat/id, true, 5, addition(4,5))]");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("[deny O mail(cat/id, true, 5, addition(4,5))]");
      _builder_2.newLine();
      _builder_2.append("}");
      Facpl _parse_1 = this._parseHelper.parse(_builder_2);
      model = _parse_1;
  ...
  @Test
  public void checkEHealth() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("PolicySet patientConsent { permit-overrides");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("target: equal ( \"Alice\" , resource / patient-id ) ");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("policies:");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("Rule writeDoc ( permit target: equal ( subject / role , \"doctor\" ) ");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("&& equal ( action / id , \"write\" ) ");
      _builder.newLine();
      _builder.append("\t\t\t");
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("Rule readDoc ( permit target: equal ( subject / role , \"doctor\" )");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("&& equal ( action / id , \"read\" ) ");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("&& in ( \"e-Pre-Read\", subject / permission ) )");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("Rule readPha ( permit target: equal ( subject / role , \"pharmacist\" ) ");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("&& equal ( action / id , \"read\" ) ");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("Rule denyRule ( deny )");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("obl:");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("[ deny M mailTo ( resource / patient-id.mail , \"Data requested by unauthorized subject\" ) ]");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("[ permit O compress ( ) ]");
      _builder.newLine();
      _builder.append("}");
      _builder.newLine();
      Facpl model = this._parseHelper.parse(_builder);
      boolean _stubCheckXACML = this.stubCheckXACML(model, "eHealth");
      Assert.assertEquals(Boolean.valueOf(_stubCheckXACML), Boolean.valueOf(true));
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
