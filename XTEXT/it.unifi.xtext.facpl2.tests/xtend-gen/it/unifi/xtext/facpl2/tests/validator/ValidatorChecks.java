...
public class ValidatorChecks {
  ...
  public void testWebExamples() {
    try {
      ...
      _builder_5.newLine();
      _builder_5.append("\t\t");
      _builder_5.append("[ permit M action1 ( subject / name ) ]");
      _builder_5.newLine();
      _builder_5.append("\t");
      _builder_5.append(")");
      _builder_5.newLine();
      ...
      _builder_5.newLine();
      _builder_5.append("\t\t");
      _builder_5.append("[ deny M action2 ( subject / name ) ]");
      _builder_5.newLine();
      _builder_5.append("\t");
      _builder_5.append(")");
      _builder_5.newLine();
      ...
      _builder_5.newLine();
      _builder_5.append("\t");
      _builder_5.append("[ permit M log ( \"Resource accessed: \" , resource / id ) ]");
      _builder_5.newLine();
      _builder_5.append("}");
      ...
      _builder_6.newLine();
      _builder_6.append("\t\t\t");
      _builder_6.append("[ permit M action1 ( subject / name ) ]");
      _builder_6.newLine();
      _builder_6.append("\t\t");
      _builder_6.append(")");
      _builder_6.newLine();
      ...
      _builder_6.newLine();
      _builder_6.append("\t\t\t");
      _builder_6.append("[ deny M action2 ( subject / name ) ]");
      _builder_6.newLine();
      _builder_6.append("\t\t");
      _builder_6.append(")");
      _builder_6.newLine();
      ...
      _builder_6.newLine();
      _builder_6.append("\t\t");
      _builder_6.append("[ deny M log ( \"Subject: \" , subject / id , subject / name ) ]");
      _builder_6.newLine();
      _builder_6.append("\t");
      _builder_6.append("}");
      _builder_6.newLine();
      ...
      _builder_6.newLine();
      _builder_6.append("\t");
      _builder_6.append("[ permit M log ( \"Resource accessed: \" , resource / id ) ]");
      _builder_6.newLine();
      _builder_6.append("\t");
      _builder_6.append("[ deny M log ( \"Resource requested: \" , resource / id ) ]");
      _builder_6.newLine();
      _builder_6.append("}");
