...
public class TypeCheck_Test {
  ...
  public void setString() {
    try {
      ...
      _builder.append("PolicySet Name {permit-overrides");
      _builder.newLine();
      _builder.append("target: in ( subject / fedoraRole ,\tset( \"researcher\" , \"professor\" , \"administrator\" )) ");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("policies: ");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("Rule id_1 ( deny target: ( ( equal ( \"urn:fedora:names:fedora:2.1:action:id-getDatastreamDissemination\" , action / id");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.append(") ) ) && ( ( equal ( \"demo:11\" , resource / resource_id ) && equal ( \"DS1\" , resource / id ) ) || ( equal (");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t\t");
      _builder.append("\"demo:11\" , resource / resource_id ) && equal ( \"RIGHTS1\" , resource / id ) ) ) &&");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t\t ");
      _builder.append("! ( in ( subject / fedoraRole ,");
      _builder.newLine();
      _builder.append("\t\t\t\t\t\t");
      _builder.append("set( \"researcher\" , \"professor\" , \"administrator\" ) ) ) ");
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      _builder.append(")");
      _builder.newLine();
