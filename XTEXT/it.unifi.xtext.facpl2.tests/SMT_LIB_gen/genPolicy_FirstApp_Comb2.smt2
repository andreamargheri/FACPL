...
(define-fun cns_obl_permit_r3 ()  Bool true )
;##### Rule Constraints
;PERMIT
...
(define-fun cns_Name_cmb_r1r2_permit () Bool
	 (or cns_r1_permit (and cns_r2_permit cns_r1_notApp))
)

(define-fun cns_Name_cmb_r1r2_deny () Bool
	 (or cns_r1_deny (and cns_r2_deny cns_r1_notApp))
)
...
(define-fun cns_Name_cmb_r1r2_indet () Bool
	 (or cns_r1_indet (and cns_r2_indet cns_r1_notApp))
)

 
(define-fun cns_Name_cmb_final_permit () Bool
	 (or cns_Name_cmb_r1r2_permit (and cns_r3_permit cns_Name_cmb_r1r2_notApp))
)

(define-fun cns_Name_cmb_final_deny () Bool
	 (or cns_Name_cmb_r1r2_deny (and cns_r3_deny cns_Name_cmb_r1r2_notApp))
)
...
(define-fun cns_Name_cmb_final_indet () Bool
	 (or cns_Name_cmb_r1r2_indet (and cns_r3_indet cns_Name_cmb_r1r2_notApp))
)
