...
public class Facpl2Parser extends AbstractContentAssistParser {
	...
	protected it.unifi.xtext.facpl.ui.contentassist.antlr.internal.InternalFacpl2Parser createParser() {
		it.unifi.xtext.facpl.ui.contentassist.antlr.internal.InternalFacpl2Parser result = new it.unifi.xtext.facpl.ui.contentassist.antlr.internal.InternalFacpl2Parser(
				null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
...

				{
					...
					put(grammarAccess.getAbstractPolicyInclAccess().getAlternatives(),
							"rule__AbstractPolicyIncl__Alternatives");
					put(grammarAccess.getObligationAccess().getTypeOblAlternatives_2_0(),
							"rule__Obligation__TypeOblAlternatives_2_0");
					put(grammarAccess.getBasicExpressionAccess().getAlternatives(),
					...
					put(grammarAccess.getFulfillmentStrategyAccess().getAlternatives(),
					...
					put(grammarAccess.getFunctionDeclarationAccess().getGroup_5(),
					...
					put(grammarAccess.getAbstractPolicyInclAccess().getGroup_1(),
					...
					put(grammarAccess.getObligationAccess().getGroup_5(), "rule__Obligation__Group_5__0");
					put(grammarAccess.getObligationAccess().getGroup_5_1(), "rule__Obligation__Group_5_1__0");
					...
					put(grammarAccess.getFacplAccess().getDeclarationsAssignment_1(),
					...
					put(grammarAccess.getMainFacplAccess().getExtIndetAssignment_4(),
							"rule__MainFacpl__ExtIndetAssignment_4");
					put(grammarAccess.getMainFacplAccess().getGenPackageAssignment_6_2(),
							"rule__MainFacpl__GenPackageAssignment_6_2");
					put(grammarAccess.getMainFacplAccess().getRefRequestAssignment_7_2_0(),
							"rule__MainFacpl__RefRequestAssignment_7_2_0");
					put(grammarAccess.getMainFacplAccess().getRefRequestAssignment_7_2_1_1(),
					...
					put(grammarAccess.getFunctionDeclarationAccess().getTypeAssignment_1(),
							"rule__FunctionDeclaration__TypeAssignment_1");
					put(grammarAccess.getFunctionDeclarationAccess().getNameAssignment_2(),
							"rule__FunctionDeclaration__NameAssignment_2");
					put(grammarAccess.getFunctionDeclarationAccess().getArgsAssignment_4(),
							"rule__FunctionDeclaration__ArgsAssignment_4");
					put(grammarAccess.getFunctionDeclarationAccess().getArgsAssignment_5_1(),
					...
					put(grammarAccess.getRequestAccess().getAttributesAssignment_4(),
							"rule__Request__AttributesAssignment_4");
					put(grammarAccess.getAttributeReqAccess().getNameAssignment_1(),
							"rule__AttributeReq__NameAssignment_1");
					put(grammarAccess.getAttributeReqAccess().getValueAssignment_3(),
							"rule__AttributeReq__ValueAssignment_3");
					put(grammarAccess.getAttributeReqAccess().getValueAssignment_4_1(),
							"rule__AttributeReq__ValueAssignment_4_1");
					put(grammarAccess.getAttributeNameAccess().getCategoryAssignment_0(),
							"rule__AttributeName__CategoryAssignment_0");
					put(grammarAccess.getAttributeNameAccess().getIdAssignment_2(),
					...
					put(grammarAccess.getAbstractPolicyInclAccess().getNewPolicyAssignment_0(),
							"rule__AbstractPolicyIncl__NewPolicyAssignment_0");
					put(grammarAccess.getAbstractPolicyInclAccess().getRefPolAssignment_1_1(),
					...
					put(grammarAccess.getPolicySetAccess().getPolSetAlgAssignment_3(),
							"rule__PolicySet__PolSetAlgAssignment_3");
					put(grammarAccess.getPolicySetAccess().getTargetAssignment_4_1(),
							"rule__PolicySet__TargetAssignment_4_1");
					put(grammarAccess.getPolicySetAccess().getPoliciesAssignment_6(),
							"rule__PolicySet__PoliciesAssignment_6");
					put(grammarAccess.getPolicySetAccess().getOblAssignment_7_1(),
							"rule__PolicySet__OblAssignment_7_1");
					put(grammarAccess.getAlgAccess().getIdAlgAssignment_0(), "rule__Alg__IdAlgAssignment_0");
					put(grammarAccess.getAlgAccess().getFStrategyAssignment_1_1(),
					...
					put(grammarAccess.getObligationAccess().getEvaluetedOnAssignment_1(),
							"rule__Obligation__EvaluetedOnAssignment_1");
					put(grammarAccess.getObligationAccess().getTypeOblAssignment_2(),
							"rule__Obligation__TypeOblAssignment_2");
					put(grammarAccess.getObligationAccess().getPepActionAssignment_3(),
							"rule__Obligation__PepActionAssignment_3");
					put(grammarAccess.getObligationAccess().getExprAssignment_5_0(),
							"rule__Obligation__ExprAssignment_5_0");
					put(grammarAccess.getObligationAccess().getExprAssignment_5_1_1(),
							"rule__Obligation__ExprAssignment_5_1_1");
					put(grammarAccess.getAndExpressionAccess().getRightAssignment_1_2(),
							"rule__AndExpression__RightAssignment_1_2");
					put(grammarAccess.getOrExpressionAccess().getRightAssignment_1_2(),
							"rule__OrExpression__RightAssignment_1_2");
					put(grammarAccess.getNotExpressionAccess().getArgAssignment_1(),
							"rule__NotExpression__ArgAssignment_1");
					put(grammarAccess.getFunctionAccess().getFunctionIdAssignment_0(),
					...
					put(grammarAccess.getDeclaredFunctionAccess().getFunctionIdAssignment_0(),
							"rule__DeclaredFunction__FunctionIdAssignment_0");
					put(grammarAccess.getDeclaredFunctionAccess().getArgsAssignment_2(),
							"rule__DeclaredFunction__ArgsAssignment_2");
					put(grammarAccess.getDeclaredFunctionAccess().getArgsAssignment_3_1(),
					...
					put(grammarAccess.getStringLiteralAccess().getValueAssignment(),
					...
					put(grammarAccess.getDoubleLiteralAccess().getValueAssignment(),
							"rule__DoubleLiteral__ValueAssignment");
					put(grammarAccess.getDateLiteralAccess().getValueAssignment(),
							"rule__DateLiteral__ValueAssignment");
					put(grammarAccess.getTimeLiteralAccess().getValueAssignment(),
