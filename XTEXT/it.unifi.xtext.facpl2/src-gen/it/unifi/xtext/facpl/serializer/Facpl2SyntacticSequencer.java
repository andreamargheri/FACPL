...
public class Facpl2SyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void init(IGrammarAccess access) {
		...
		match_PolicySet_OblKeyword_7_0_q = new TokenAlias(false, true, grammarAccess.getPolicySetAccess().getOblKeyword_7_0());
	 ...
	 *
	 * This ambiguous syntax occurs at:
	 *     policies+=AbstractPolicyIncl (ambiguity) '}' (rule end)
	 */
	protected void emit_PolicySet_OblKeyword_7_0_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
