...
public class Facpl2SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_Function(ISerializationContext context, Function semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, Facpl2Package.Literals.FUNCTION__FUNCTION_ID) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Facpl2Package.Literals.FUNCTION__FUNCTION_ID));
			if (transientValues.isValueTransient(semanticObject, Facpl2Package.Literals.FUNCTION__ARG1) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Facpl2Package.Literals.FUNCTION__ARG1));
			if (transientValues.isValueTransient(semanticObject, Facpl2Package.Literals.FUNCTION__ARG2) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Facpl2Package.Literals.FUNCTION__ARG2));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFunctionAccess().getFunctionIdFunIDEnumRuleCall_0_0(), semanticObject.getFunctionId());
		feeder.accept(grammarAccess.getFunctionAccess().getArg1ExpressionParserRuleCall_2_0(), semanticObject.getArg1());
		feeder.accept(grammarAccess.getFunctionAccess().getArg2ExpressionParserRuleCall_4_0(), semanticObject.getArg2());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     ((typeObl='M' | typeObl='O') pepAction=ID (expr+=Expression expr+=Expression*)*)
	 */
	...
	protected void sequence_PAF(ISerializationContext context, PAF semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, Facpl2Package.Literals.PAF__PEP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Facpl2Package.Literals.PAF__PEP));
			if (transientValues.isValueTransient(semanticObject, Facpl2Package.Literals.PAF__PDP) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, Facpl2Package.Literals.PAF__PDP));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
