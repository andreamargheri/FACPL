...
public abstract class AbstractFacpl2RuntimeModule extends org.eclipse.xtext.common.types.DefaultCommonTypesRuntimeModule {
	...
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("it.unifi.xtext.facpl.Facpl2");
	}
	...
	public com.google.inject.Provider<it.unifi.xtext.facpl.parser.antlr.internal.InternalFacpl2Lexer> provideInternalFacpl2Lexer() {
		return org.eclipse.xtext.parser.antlr.LexerProvider.create(it.unifi.xtext.facpl.parser.antlr.internal.InternalFacpl2Lexer.class);
	}

	// contributed by org.eclipse.xtext.generator.parser.antlr.XtextAntlrGeneratorFragment
	public void configureRuntimeLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.parser.antlr.LexerBindings.RUNTIME)).to(it.unifi.xtext.facpl.parser.antlr.internal.InternalFacpl2Lexer.class);
	}
	...
	@org.eclipse.xtext.service.SingletonBinding(eager=true)	public Class<? extends it.unifi.xtext.facpl.validation.Facpl2Validator> bindFacpl2Validator() {
