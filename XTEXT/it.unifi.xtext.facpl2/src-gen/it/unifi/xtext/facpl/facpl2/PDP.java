...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>PDP</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface PDP extends EObject
{
   ...
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Pdp Alg</em>' containment reference isn't clear,
  ...
  /**
   * Sets the value of the '{@link it.unifi.xtext.facpl.facpl2.PDP#getPdpAlg <em>Pdp Alg</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Pdp Alg</em>' containment reference.
   * @see #getPdpAlg()
   * @generated
   */
  ...
  /**
   * Returns the value of the '<em><b>Pol Set</b></em>' containment reference list.
   * The list contents are of type {@link it.unifi.xtext.facpl.facpl2.AbstractPolicyIncl}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Pol Set</em>' containment reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
