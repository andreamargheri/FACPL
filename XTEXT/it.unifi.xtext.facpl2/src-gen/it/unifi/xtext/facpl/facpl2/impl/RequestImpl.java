 ...
 * </p>
 * <ul>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.RequestImpl#getStub <em>Stub</em>
 * }</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.RequestImpl#getName <em>Name</em>
 * }</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.RequestImpl#getAttributes
 * <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
...
public class RequestImpl extends MinimalEObjectImpl.Container implements Request {
	...
	public EList<AttributeReq> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<AttributeReq>(AttributeReq.class, this,
					Facpl2Package.REQUEST__ATTRIBUTES);
		}
		return attributes;
	}
