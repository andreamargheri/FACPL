...
public interface PAF extends EObject {
	/**
	 * Returns the value of the '<em><b>Pep</b></em>' attribute. The literals
	 * are from the enumeration {@link it.unifi.xtext.facpl.facpl2.PEPAlg}. <!--
	 * begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Pep</em>' attribute isn't clear, there really
	...
	/**
	 * Sets the value of the '{@link it.unifi.xtext.facpl.facpl2.PAF#getPep
	 * <em>Pep</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Pep</em>' attribute.
	 * @see it.unifi.xtext.facpl.facpl2.PEPAlg
	 * @see #getPep()
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link it.unifi.xtext.facpl.facpl2.PAF#getPdp
	 * <em>Pdp</em>}' containment reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Pdp</em>' containment reference.
	 * @see #getPdp()
	 * @generated
	 */
