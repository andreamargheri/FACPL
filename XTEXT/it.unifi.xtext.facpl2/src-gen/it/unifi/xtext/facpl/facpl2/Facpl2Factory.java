...
public interface Facpl2Factory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Facpl</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Main Facpl</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>PAF</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Request</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>PDP</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Policy Set</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Alg</em>'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Obligation</em>'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
