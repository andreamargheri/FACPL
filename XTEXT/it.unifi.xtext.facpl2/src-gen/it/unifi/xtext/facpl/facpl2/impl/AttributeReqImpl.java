...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Attribute Req</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.AttributeReqImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.AttributeReqImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeReqImpl extends MinimalEObjectImpl.Container implements AttributeReq
{
  ...
  public NotificationChain basicSetName(AttributeName newName, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Facpl2Package.ATTRIBUTE_REQ__NAME, oldName, newName);
  ...
  public void setName(AttributeName newName)
  {
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.ATTRIBUTE_REQ__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.ATTRIBUTE_REQ__NAME, null, msgs);
