...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>fun ID</b></em>',
...
public enum funID implements Enumerator
{
  ...
  /**
   * The '<em><b>NEQUAL</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #NEQUAL_VALUE
   * @generated
  ...
  /**
   * The '<em><b>NEQUAL</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   ...
   * @generated
   */
  private static final funID[] VALUES_ARRAY =
    new funID[]
    {
      EQUAL,
      NEQUAL,
  ...
  /**
   * Returns the '<em><b>fun ID</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the '<em><b>fun ID</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public static funID get(int value)
  {
    switch (value)
    {
      ...
      case NEQUAL_VALUE: return NEQUAL;
