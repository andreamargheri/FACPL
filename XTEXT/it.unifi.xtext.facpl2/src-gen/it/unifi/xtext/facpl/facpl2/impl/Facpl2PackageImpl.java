...
public class Facpl2PackageImpl extends EPackageImpl implements Facpl2Package
{
   ...
   * @generated
   */
  private EClass mapFunctionEClass = null;
   ...
   * @generated
   */
  public EReference getPolicySet_Oblp()
  {
   ...
   * @generated
   */
  public EReference getPolicySet_Obld()
  {
   ...
   * @generated
   */
  public EClass getMapFunction()
  {
    return mapFunctionEClass;
  }
   ...
   * @generated
   */
  public EReference getMapFunction_Arg1()
  {
    return (EReference)mapFunctionEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getMapFunction_Arg2()
  {
    return (EReference)mapFunctionEClass.getEStructuralFeatures().get(2);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(policySetEClass, POLICY_SET__OBLP);
    createEReference(policySetEClass, POLICY_SET__OBLD);
    ...
    createEReference(ruleEClass, RULE__OBL);
    ...
    mapFunctionEClass = createEClass(MAP_FUNCTION);
    createEAttribute(mapFunctionEClass, MAP_FUNCTION__FUNCTION_ID);
    createEReference(mapFunctionEClass, MAP_FUNCTION__ARG1);
    createEReference(mapFunctionEClass, MAP_FUNCTION__ARG2);
  ...
  public void initializePackageContents()
  {
    ...
    mapFunctionEClass.getESuperTypes().add(this.getExpression());
    ...
    initEReference(getPolicySet_Oblp(), this.getObligation(), null, "oblp", null, 0, -1, PolicySet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getPolicySet_Obld(), this.getObligation(), null, "obld", null, 0, -1, PolicySet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRule_Obl(), this.getObligation(), null, "obl", null, 0, -1, Rule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
