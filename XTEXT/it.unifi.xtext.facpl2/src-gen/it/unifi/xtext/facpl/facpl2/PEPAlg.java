...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>PEP Alg</b></em>',
...
public enum PEPAlg implements Enumerator
{
   ...
   * @generated
   */
  private static final PEPAlg[] VALUES_ARRAY =
    new PEPAlg[]
    {
      BASE,
      DENY,
  ...
  /**
   * Returns the '<em><b>PEP Alg</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the '<em><b>PEP Alg</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
