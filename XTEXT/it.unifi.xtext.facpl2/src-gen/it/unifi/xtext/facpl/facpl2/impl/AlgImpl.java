...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Alg</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.AlgImpl#getIdAlg <em>Id Alg</em>}</li>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.AlgImpl#getFStrategy <em>FStrategy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlgImpl extends MinimalEObjectImpl.Container implements Alg
{
  ...
  /**
   * The default value of the '{@link #getFStrategy() <em>FStrategy</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getFStrategy()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getFStrategy() <em>FStrategy</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getFStrategy()
   * @generated
  ...
  public void setFStrategy(FulfillmentStrategy newFStrategy)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.ALG__FSTRATEGY, oldFStrategy, fStrategy));
  }
