...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PAF</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.PAFImpl#getStatus <em>Status</em>}</li>
...
public class PAFImpl extends MinimalEObjectImpl.Container implements PAF
{
  ...
  /**
   * The cached value of the '{@link #getPdp() <em>Pdp</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getPdp()
   * @generated
  ...
  public NotificationChain basicSetStatus(STATUS newStatus, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Facpl2Package.PAF__STATUS, oldStatus, newStatus);
  ...
  public void setStatus(STATUS newStatus)
  {
    if (newStatus != status)
    {
      ...
      if (status != null)
        msgs = ((InternalEObject)status).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.PAF__STATUS, null, msgs);
      if (newStatus != null)
        msgs = ((InternalEObject)newStatus).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.PAF__STATUS, null, msgs);
      msgs = basicSetStatus(newStatus, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.PAF__STATUS, newStatus, newStatus));
  }
  ...
  public NotificationChain basicSetPdp(PDP newPdp, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Facpl2Package.PAF__PDP, oldPdp, newPdp);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setPdp(PDP newPdp)
  {
    if (newPdp != pdp)
    {
      NotificationChain msgs = null;
      if (pdp != null)
        msgs = ((InternalEObject)pdp).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.PAF__PDP, null, msgs);
      if (newPdp != null)
        msgs = ((InternalEObject)newPdp).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.PAF__PDP, null, msgs);
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Facpl2Package.PAF__STATUS:
