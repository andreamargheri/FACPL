 ...
 * </p>
 * <ul>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.FunctionDeclaration#getType <em>Type</em>}</li>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.FunctionDeclaration#getName <em>Name</em>}</li>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.FunctionDeclaration#getArgs <em>Args</em>}</li>
 * </ul>
 *
...
public interface FunctionDeclaration extends EObject
{
   ...
   * The literals are from the enumeration {@link it.unifi.xtext.facpl.facpl2.TypeLiteral}.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * Sets the value of the '{@link it.unifi.xtext.facpl.facpl2.FunctionDeclaration#getType <em>Type</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link it.unifi.xtext.facpl.facpl2.FunctionDeclaration#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * The list contents are of type {@link it.unifi.xtext.facpl.facpl2.TypeLiteral}.
   * The literals are from the enumeration {@link it.unifi.xtext.facpl.facpl2.TypeLiteral}.
   * <!-- begin-user-doc -->
   * <p>
