 ...
 * </p>
 * <ul>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.FacplImpl#getImportEl
 * <em>Import El</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.FacplImpl#getDeclarations
 * <em>Declarations</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.FacplImpl#getPolicies
 * <em>Policies</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.FacplImpl#getRequests
 * <em>Requests</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.FacplImpl#getMain <em>Main</em>}
 * </li>
 * </ul>
 *
 * @generated
...
public class FacplImpl extends MinimalEObjectImpl.Container implements Facpl {
	/**
	 * The cached value of the '{@link #getImportEl() <em>Import El</em>}'
	...
	public EList<FunctionDeclaration> getDeclarations() {
		if (declarations == null) {
			declarations = new EObjectContainmentEList<FunctionDeclaration>(FunctionDeclaration.class, this,
					Facpl2Package.FACPL__DECLARATIONS);
		}
		return declarations;
	}
	...
	public NotificationChain basicSetMain(MainFacpl newMain, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Facpl2Package.FACPL__MAIN,
					oldMain, newMain);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setMain(MainFacpl newMain) {
		if (newMain != main) {
			...
			if (main != null)
				msgs = ((InternalEObject) main).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.FACPL__MAIN,
						null, msgs);
			if (newMain != null)
				msgs = ((InternalEObject) newMain).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.FACPL__MAIN,
						null, msgs);
