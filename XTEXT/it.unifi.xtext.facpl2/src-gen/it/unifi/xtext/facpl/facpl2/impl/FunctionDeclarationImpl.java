 ...
 * </p>
 * <ul>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.FunctionDeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.FunctionDeclarationImpl#getName <em>Name</em>}</li>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.FunctionDeclarationImpl#getArgs <em>Args</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FunctionDeclarationImpl extends MinimalEObjectImpl.Container implements FunctionDeclaration
{
  ...
  public void setType(TypeLiteral newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.FUNCTION_DECLARATION__TYPE, oldType, type));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.FUNCTION_DECLARATION__NAME, oldName, name));
  }
