 ...
 * <em><b>Main Facpl</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.MainFacplImpl#getExtIndet
 * <em>Ext Indet</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.MainFacplImpl#getGenPackage
 * <em>Gen Package</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.MainFacplImpl#getRefRequest
 * <em>Ref Request</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.MainFacplImpl#getPaf <em>Paf</em>
 * }</li>
 * </ul>
 *
 * @generated
...
public class MainFacplImpl extends MinimalEObjectImpl.Container implements MainFacpl {
	/**
	 * The cached value of the '{@link #getExtIndet() <em>Ext Indet</em>}'
	...
	/**
	 * The default value of the '{@link #getGenPackage() <em>Gen Package</em>}'
	...
	/**
	 * The cached value of the '{@link #getGenPackage() <em>Gen Package</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getGenPackage()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getRefRequest() <em>Ref Request</em>}'
	...
	/**
	 * The cached value of the '{@link #getPaf() <em>Paf</em>}' containment
	...
	public NotificationChain basicSetExtIndet(BooleanLiteral newExtIndet, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Facpl2Package.MAIN_FACPL__EXT_INDET, oldExtIndet, newExtIndet);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setExtIndet(BooleanLiteral newExtIndet) {
		if (newExtIndet != extIndet) {
			...
			if (extIndet != null)
				msgs = ((InternalEObject) extIndet).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Facpl2Package.MAIN_FACPL__EXT_INDET, null, msgs);
			if (newExtIndet != null)
				msgs = ((InternalEObject) newExtIndet).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - Facpl2Package.MAIN_FACPL__EXT_INDET, null, msgs);
			msgs = basicSetExtIndet(newExtIndet, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.MAIN_FACPL__EXT_INDET, newExtIndet,
					newExtIndet));
	}
	...
	public void setGenPackage(String newGenPackage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.MAIN_FACPL__GEN_PACKAGE, oldGenPackage,
					genPackage));
	}
	...
	public NotificationChain basicSetPaf(PAF newPaf, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Facpl2Package.MAIN_FACPL__PAF, oldPaf, newPaf);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPaf(PAF newPaf) {
		if (newPaf != paf) {
			NotificationChain msgs = null;
			if (paf != null)
				msgs = ((InternalEObject) paf).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Facpl2Package.MAIN_FACPL__PAF, null, msgs);
			if (newPaf != null)
				msgs = ((InternalEObject) newPaf).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE - Facpl2Package.MAIN_FACPL__PAF, null, msgs);
