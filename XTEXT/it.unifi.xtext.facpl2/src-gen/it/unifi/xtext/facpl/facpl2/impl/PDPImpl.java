...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>PDP</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.PDPImpl#getPdpAlg <em>Pdp Alg</em>}</li>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.PDPImpl#getPolSet <em>Pol Set</em>}</li>
 * </ul>
 *
 * @generated
 */
...
{
  /**
   * The cached value of the '{@link #getPdpAlg() <em>Pdp Alg</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getPdpAlg()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getPolSet() <em>Pol Set</em>}' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getPolSet()
   * @generated
  ...
  public NotificationChain basicSetPdpAlg(Alg newPdpAlg, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Facpl2Package.PDP__PDP_ALG, oldPdpAlg, newPdpAlg);
  ...
  public void setPdpAlg(Alg newPdpAlg)
  {
    if (newPdpAlg != pdpAlg)
    {
      ...
      if (pdpAlg != null)
        msgs = ((InternalEObject)pdpAlg).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.PDP__PDP_ALG, null, msgs);
      if (newPdpAlg != null)
        msgs = ((InternalEObject)newPdpAlg).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.PDP__PDP_ALG, null, msgs);
  ...
  public EList<AbstractPolicyIncl> getPolSet()
  {
    if (polSet == null)
    {
      polSet = new EObjectContainmentEList<AbstractPolicyIncl>(AbstractPolicyIncl.class, this, Facpl2Package.PDP__POL_SET);
    }
    return polSet;
  }
