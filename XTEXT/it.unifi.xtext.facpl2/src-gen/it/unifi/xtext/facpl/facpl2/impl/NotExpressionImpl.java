 ...
 * <em><b>Not Expression</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.NotExpressionImpl#getArg
 * <em>Arg</em>}</li>
 * </ul>
 *
 * @generated
...
public class NotExpressionImpl extends ExpressionImpl implements NotExpression {
	/**
	 * The cached value of the '{@link #getArg() <em>Arg</em>}' containment
	...
	protected EClass eStaticClass() {
		return Facpl2Package.Literals.NOT_EXPRESSION;
	}
	...
	public NotificationChain basicSetArg(Expression newArg, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Facpl2Package.NOT_EXPRESSION__ARG, oldArg, newArg);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newArg != arg) {
			...
			if (arg != null)
				msgs = ((InternalEObject) arg).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Facpl2Package.NOT_EXPRESSION__ARG, null, msgs);
			if (newArg != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.NOT_EXPRESSION__ARG, newArg, newArg));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Facpl2Package.NOT_EXPRESSION__ARG:
