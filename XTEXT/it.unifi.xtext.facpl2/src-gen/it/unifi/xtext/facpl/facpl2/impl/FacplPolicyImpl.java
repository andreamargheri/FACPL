 ...
 * </p>
 * <ul>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.FacplPolicyImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.FacplPolicyImpl#getTarget
 * <em>Target</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.FacplPolicyImpl#getObl
 * <em>Obl</em>}</li>
 * </ul>
 *
 * @generated
...
public class FacplPolicyImpl extends MinimalEObjectImpl.Container implements FacplPolicy {
	...
	/**
	 * The cached value of the '{@link #getObl() <em>Obl</em>}' containment
	...
	public NotificationChain basicSetTarget(Expression newTarget, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Facpl2Package.FACPL_POLICY__TARGET, oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTarget != target) {
			...
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Facpl2Package.FACPL_POLICY__TARGET, null, msgs);
			if (newTarget != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.FACPL_POLICY__TARGET, newTarget,
					newTarget));
	}
