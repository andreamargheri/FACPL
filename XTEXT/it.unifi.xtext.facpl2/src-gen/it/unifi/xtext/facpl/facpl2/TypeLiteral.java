...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Type Literal</b></em>',
...
public enum TypeLiteral implements Enumerator
{
  ...
  /**
   * The '<em><b>Set Int</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #SET_INT_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Set Double</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The '<em><b>Set Bool</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #SET_BOOL_VALUE
   * @generated
  ...
  /**
   * The '<em><b>Set String</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The '<em><b>Set Date Time</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * The '<em><b>Set Int</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * The '<em><b>Set Double</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Set Double</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #SET_DOUBLE
  ...
  /**
   * The '<em><b>Set Bool</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
  ...
  /**
   * The '<em><b>Set String</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Set String</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #SET_STRING
  ...
  /**
   * The '<em><b>Set Date Time</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Set Date Time</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #SET_DATE_TIME
   ...
   * @generated
   */
  private static final TypeLiteral[] VALUES_ARRAY =
    new TypeLiteral[]
    {
      INT,
      DOUBLE,
  ...
  /**
   * A public read-only list of all the '<em><b>Type Literal</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Type Literal</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the '<em><b>Type Literal</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
  ...
  /**
   * Returns the '<em><b>Type Literal</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  public static TypeLiteral get(int value)
  {
    switch (value)
    {
      ...
      case SET_INT_VALUE: return SET_INT;
      case SET_DOUBLE_VALUE: return SET_DOUBLE;
      case SET_BOOL_VALUE: return SET_BOOL;
      case SET_STRING_VALUE: return SET_STRING;
      case SET_DATE_TIME_VALUE: return SET_DATE_TIME;
    }
    return null;
  }
