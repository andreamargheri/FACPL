...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Policy Incl</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.AbstractPolicyInclImpl#getNewPolicy <em>New Policy</em>}</li>
 *   <li>{@link it.unifi.xtext.facpl.facpl2.impl.AbstractPolicyInclImpl#getRefPol <em>Ref Pol</em>}</li>
 * </ul>
 *
 * @generated
 */
...
{
  /**
   * The cached value of the '{@link #getNewPolicy() <em>New Policy</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getNewPolicy()
   * @generated
  ...
  /**
   * The cached value of the '{@link #getRefPol() <em>Ref Pol</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #getRefPol()
   * @generated
  ...
  public NotificationChain basicSetNewPolicy(FacplPolicy newNewPolicy, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Facpl2Package.ABSTRACT_POLICY_INCL__NEW_POLICY, oldNewPolicy, newNewPolicy);
  ...
  public void setNewPolicy(FacplPolicy newNewPolicy)
  {
    if (newNewPolicy != newPolicy)
    {
      ...
      if (newPolicy != null)
        msgs = ((InternalEObject)newPolicy).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.ABSTRACT_POLICY_INCL__NEW_POLICY, null, msgs);
      if (newNewPolicy != null)
        msgs = ((InternalEObject)newNewPolicy).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Facpl2Package.ABSTRACT_POLICY_INCL__NEW_POLICY, null, msgs);
      msgs = basicSetNewPolicy(newNewPolicy, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.ABSTRACT_POLICY_INCL__NEW_POLICY, newNewPolicy, newNewPolicy));
  }
  ...
  public PolicySet getRefPol()
  {
    if (refPol != null && refPol.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, Facpl2Package.ABSTRACT_POLICY_INCL__REF_POL, oldRefPol, refPol));
      }
    }
    return refPol;
  }
  ...
  public void setRefPol(PolicySet newRefPol)
  {
    ...
    refPol = newRefPol;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.ABSTRACT_POLICY_INCL__REF_POL, oldRefPol, refPol));
  }
