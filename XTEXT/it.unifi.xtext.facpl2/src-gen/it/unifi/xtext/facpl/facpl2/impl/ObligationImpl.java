 ...
 * </p>
 * <ul>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.ObligationImpl#getEvaluetedOn
 * <em>Evalueted On</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.ObligationImpl#getTypeObl
 * <em>Type Obl</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.ObligationImpl#getPepAction
 * <em>Pep Action</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.ObligationImpl#getExpr
 * <em>Expr</em>}</li>
 * </ul>
 *
 * @generated
...
public class ObligationImpl extends MinimalEObjectImpl.Container implements Obligation {
	/**
	 * The default value of the '{@link #getEvaluetedOn() <em>Evalueted On</em>}
	...
	/**
	 * The cached value of the '{@link #getEvaluetedOn() <em>Evalueted On</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getEvaluetedOn()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getTypeObl() <em>Type Obl</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getTypeObl()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getTypeObl() <em>Type Obl</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getTypeObl()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getPepAction() <em>Pep Action</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getPepAction()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPepAction() <em>Pep Action</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getPepAction()
	 * @generated
	...
	public void setEvaluetedOn(Effect newEvaluetedOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.OBLIGATION__EVALUETED_ON,
					oldEvaluetedOn, evaluetedOn));
	}
	...
	public void setTypeObl(String newTypeObl) {
		...
		typeObl = newTypeObl;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.OBLIGATION__TYPE_OBL, oldTypeObl,
					typeObl));
	}
	...
	public void setPepAction(String newPepAction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.OBLIGATION__PEP_ACTION, oldPepAction,
					pepAction));
	}
