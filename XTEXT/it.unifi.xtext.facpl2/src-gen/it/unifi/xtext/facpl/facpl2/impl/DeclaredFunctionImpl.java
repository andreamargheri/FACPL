 ...
 * <ul>
 * <li>
 * {@link it.unifi.xtext.facpl.facpl2.impl.DeclaredFunctionImpl#getFunctionId
 * <em>Function Id</em>}</li>
 * <li>{@link it.unifi.xtext.facpl.facpl2.impl.DeclaredFunctionImpl#getArgs
 * <em>Args</em>}</li>
 * </ul>
 *
 * @generated
...
public class DeclaredFunctionImpl extends ExpressionImpl implements DeclaredFunction {
			...
			if (functionId != oldFunctionId) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Facpl2Package.DECLARED_FUNCTION__FUNCTION_ID, oldFunctionId, functionId));
			}
		}
		return functionId;
	}
	...
	public void setFunctionId(FunctionDeclaration newFunctionId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Facpl2Package.DECLARED_FUNCTION__FUNCTION_ID,
	...
	public EList<Expression> getArgs() {
		if (args == null) {
			args = new EObjectContainmentEList<Expression>(Expression.class, this,
					Facpl2Package.DECLARED_FUNCTION__ARGS);
		}
		return args;
	}
