...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Fulfillment Strategy</b></em>',
...
public enum FulfillmentStrategy implements Enumerator
{
   ...
   * @generated
   */
  private static final FulfillmentStrategy[] VALUES_ARRAY =
    new FulfillmentStrategy[]
    {
      GREEDY,
      ALL,
    };
  ...
  /**
   * A public read-only list of all the '<em><b>Fulfillment Strategy</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  ...
  /**
   * Returns the '<em><b>Fulfillment Strategy</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the '<em><b>Fulfillment Strategy</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param name the name.
   * @return the matching enumerator or <code>null</code>.
  ...
  /**
   * Returns the '<em><b>Fulfillment Strategy</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
