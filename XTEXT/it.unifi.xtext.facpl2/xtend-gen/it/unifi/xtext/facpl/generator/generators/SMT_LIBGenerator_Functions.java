...
public class SMT_LIBGenerator_Functions {
  ...
  public static CharSequence getEqualityFunctions() {
    ...
    _builder.newLine();
    _builder.append("(define-fun ");
    String _string_3 = funID.NEQUAL.toString();
    String _replaceAll = _string_3.replaceAll("-", "");
    ...
    _builder.newLine();
    _builder.append("(define-fun ");
    String _string_4 = funID.NEQUAL.toString();
    ...
    _builder.newLine();
    _builder.append("(define-fun ");
    String _string_5 = funID.NEQUAL.toString();
    String _replaceAll_2 = _string_5.replaceAll("-", "");
