...
class SMT_LIBGenerator_Functions {
	...
	(define-fun «funID.NEQUAL.toString.replaceAll('-','')»Bool ((x (TValue Bool)) (y (TValue Bool))) (TValue Bool)
		(ite (or (err x) (err y))
			(mk-val false false true)
			(ite (or (miss x) (miss y))
				(mk-val false true false)
	...
	(define-fun «funID.NEQUAL.toString.replaceAll('-','')»Int ((x (TValue Int)) (y (TValue Int))) (TValue Bool)
		(ite (or (err x) (err y))
			(mk-val false false true)
			(ite (or (miss x) (miss y))
				(mk-val false true false)
	...
	(define-fun «funID.NEQUAL.toString.replaceAll('-','')»Real ((x (TValue Real)) (y (TValue Real))) (TValue Bool)
		(ite (or (err x) (err y))
			(mk-val false false true)
			(ite (or (miss x) (miss y))
				(mk-val false true false)
