...
public class StringComparisonEvaluatorStatus implements IComparisonEvaluatorStatus {
	
	private static StringComparisonEvaluatorStatus instance; 
	
	private StringComparisonEvaluatorStatus(){
		
	}
	
	public static StringComparisonEvaluatorStatus getInstance(){
		if (instance == null){
			instance = new StringComparisonEvaluatorStatus();
		}
		return instance;
	}
