...
public class PolicySet_firstPolicy_denyOverrides extends PolicySet {
	public PolicySet_firstPolicy_denyOverrides() {
		...
		// Target
		addTarget(new ExpressionFunction(new it.unifi.facpl.lib.function.comparison.Equal(), "4567-1",
	...
	private class Rule_RuleCondition_D extends Rule {
		...
		Rule_RuleCondition_D() {
			...
			// Target
			addTarget(new ExpressionFunction(new it.unifi.facpl.lib.function.comparison.In(),
