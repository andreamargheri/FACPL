...
public class ContextRequest_TimeRequest {
	...
	private static FacplStatus createStatus() {
		...
		attributeList.add(new StatusAttribute("counter", FacplStatusType.INT, "0"));
		attributeList.add(new StatusAttribute("lastAccess", FacplStatusType.DATE,"15:34:59"));
