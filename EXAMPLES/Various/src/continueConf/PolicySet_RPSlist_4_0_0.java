...
public class PolicySet_RPSlist_4_0_0 extends PolicySet {
	public PolicySet_RPSlist_4_0_0(){
		addId("RPSlist_4_0_0");
		//Algorithm Combining
		...
		//PolElements
		addPolicyElement(new Rule_RPSlist_4_0_0_r_1());
		//Obligation
		}
		
		private class Rule_RPSlist_4_0_0_r_1 extends Rule {
			
				Rule_RPSlist_4_0_0_r_1 (){
					addId("RPSlist_4_0_0_r_1");
					//Effect
