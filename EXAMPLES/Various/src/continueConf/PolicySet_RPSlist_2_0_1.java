...
public class PolicySet_RPSlist_2_0_1 extends PolicySet {
	public PolicySet_RPSlist_2_0_1(){
		addId("RPSlist_2_0_1");
		//Algorithm Combining
		...
		//PolElements
		addPolicyElement(new Rule_RPSlist_2_0_1_r_1());
		//Obligation
		}
		
		private class Rule_RPSlist_2_0_1_r_1 extends Rule {
			
				Rule_RPSlist_2_0_1_r_1 (){
					addId("RPSlist_2_0_1_r_1");
					//Effect
