...
public class PolicySet_RPSlist_23_0_0_1_4 extends PolicySet {
	public PolicySet_RPSlist_23_0_0_1_4(){
		addId("RPSlist_23_0_0_1_4");
		//Algorithm Combining
		...
		//PolElements
		addPolicyElement(new Rule_RPSlist_23_0_0_1_4_r_1());
		addPolicyElement(new Rule_RPSlist_23_0_0_1_4_r_2());
		addPolicyElement(new Rule_RPSlist_23_0_0_1_4_r_3());
		addPolicyElement(new Rule_RPSlist_23_0_0_1_4_r_4());
		addPolicyElement(new Rule_RPSlist_23_0_0_1_4_r_5());
		//Obligation
		}
		
		private class Rule_RPSlist_23_0_0_1_4_r_1 extends Rule {
			
				Rule_RPSlist_23_0_0_1_4_r_1 (){
					addId("RPSlist_23_0_0_1_4_r_1");
					//Effect
		...
		private class Rule_RPSlist_23_0_0_1_4_r_2 extends Rule {
			
				Rule_RPSlist_23_0_0_1_4_r_2 (){
					addId("RPSlist_23_0_0_1_4_r_2");
					//Effect
					addEffect(Effect.PERMIT);
					//Target
		...
		private class Rule_RPSlist_23_0_0_1_4_r_3 extends Rule {
			
				Rule_RPSlist_23_0_0_1_4_r_3 (){
					addId("RPSlist_23_0_0_1_4_r_3");
					//Effect
					addEffect(Effect.PERMIT);
					//Target
		...
		private class Rule_RPSlist_23_0_0_1_4_r_4 extends Rule {
			
				Rule_RPSlist_23_0_0_1_4_r_4 (){
					addId("RPSlist_23_0_0_1_4_r_4");
					//Effect
					addEffect(Effect.PERMIT);
					//Target
		...
		private class Rule_RPSlist_23_0_0_1_4_r_5 extends Rule {
			
				Rule_RPSlist_23_0_0_1_4_r_5 (){
					addId("RPSlist_23_0_0_1_4_r_5");
					//Effect
