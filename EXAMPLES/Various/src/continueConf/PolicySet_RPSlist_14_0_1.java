...
public class PolicySet_RPSlist_14_0_1 extends PolicySet {
	public PolicySet_RPSlist_14_0_1(){
		addId("RPSlist_14_0_1");
		//Algorithm Combining
		...
		)),new ExpressionBooleanTree(new ExpressionFunction(new it.unifi.facpl.lib.function.comparison.Equal(), "true",new AttributeName("subject","isConflicted") 
		)))
		))
		);
		//PolElements
		addPolicyElement(new Rule_RPSlist_14_0_1_r_1());
		//Obligation
		}
		
		private class Rule_RPSlist_14_0_1_r_1 extends Rule {
			
				Rule_RPSlist_14_0_1_r_1 (){
					addId("RPSlist_14_0_1_r_1");
					//Effect
