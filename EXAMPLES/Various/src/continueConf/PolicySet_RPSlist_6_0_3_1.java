...
public class PolicySet_RPSlist_6_0_3_1 extends PolicySet {
	public PolicySet_RPSlist_6_0_3_1(){
		addId("RPSlist_6_0_3_1");
		//Algorithm Combining
		...
		//PolElements
		addPolicyElement(new Rule_RPSlist_6_0_3_1_r_1());
		//Obligation
		}
		
		private class Rule_RPSlist_6_0_3_1_r_1 extends Rule {
			
				Rule_RPSlist_6_0_3_1_r_1 (){
					addId("RPSlist_6_0_3_1_r_1");
					//Effect
