...
public class PolicySet_RPSlist_9_0_2 extends PolicySet {
	public PolicySet_RPSlist_9_0_2(){
		addId("RPSlist_9_0_2");
		//Algorithm Combining
		...
		//PolElements
		addPolicyElement(new Rule_RPSlist_9_0_2_r_1());
		//Obligation
		}
		
		private class Rule_RPSlist_9_0_2_r_1 extends Rule {
			
				Rule_RPSlist_9_0_2_r_1 (){
					addId("RPSlist_9_0_2_r_1");
					//Effect
