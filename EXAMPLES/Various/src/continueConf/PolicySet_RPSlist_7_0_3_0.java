...
public class PolicySet_RPSlist_7_0_3_0 extends PolicySet {
	public PolicySet_RPSlist_7_0_3_0(){
		addId("RPSlist_7_0_3_0");
		//Algorithm Combining
		...
		//PolElements
		addPolicyElement(new Rule_RPSlist_7_0_3_0_r_1());
		//Obligation
		}
		
		private class Rule_RPSlist_7_0_3_0_r_1 extends Rule {
			
				Rule_RPSlist_7_0_3_0_r_1 (){
					addId("RPSlist_7_0_3_0_r_1");
					//Effect
