...
public class PolicySet_RPSlist_22_0_0_0 extends PolicySet {
	public PolicySet_RPSlist_22_0_0_0(){
		addId("RPSlist_22_0_0_0");
		//Algorithm Combining
		addCombiningAlg(new it.unifi.facpl.lib.algorithm.FirstApplicable());
		//Target
		addTarget(new ExpressionBooleanTree(ExprBooleanConnector.AND,new ExpressionBooleanTree(new ExpressionBooleanTree(ExprBooleanConnector.OR,new ExpressionBooleanTree(new ExpressionBooleanTree(ExprBooleanConnector.OR,new ExpressionBooleanTree(new ExpressionFunction(new it.unifi.facpl.lib.function.comparison.Equal(), "write",new AttributeName("action","action-type") 
		...
		//PolElements
		addPolicyElement(new Rule_RPSlist_22_0_0_0_r_1());
		//Obligation
		}
		
		private class Rule_RPSlist_22_0_0_0_r_1 extends Rule {
			
				Rule_RPSlist_22_0_0_0_r_1 (){
					addId("RPSlist_22_0_0_0_r_1");
					//Effect
