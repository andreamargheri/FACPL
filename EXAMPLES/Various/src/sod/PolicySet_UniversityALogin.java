...
public class PolicySet_UniversityALogin extends PolicySet {
	public PolicySet_UniversityALogin(){
		...
		//Target
		addTarget(new ExpressionBooleanTree(ExprBooleanConnector.AND,new ExpressionBooleanTree(new ExpressionBooleanTree(ExprBooleanConnector.AND,new ExpressionBooleanTree(new ExpressionBooleanTree(ExprBooleanConnector.AND,new ExpressionBooleanTree(new ExpressionFunction(it.unifi.facpl.lib.function.comparison.Equal.class, "University A",new AttributeName("resource","destination") 
		)
		...
		),new ExpressionBooleanTree(new ExpressionFunction(it.unifi.facpl.lib.function.comparison.Equal.class, "Corporation B",new AttributeName("subject","locality") 
		)
		))
		...
		private class Rule_rule1A extends Rule {
				...
				Rule_rule1A (){
					...
					//Target
					addTarget(new ExpressionBooleanTree(ExprBooleanConnector.AND,new ExpressionBooleanTree(new ExpressionFunction(it.unifi.facpl.lib.function.comparison.Equal.class, "Login",new AttributeName("action","action-id") 
					)
