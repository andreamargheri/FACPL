	...
	public PolicySet_SLA_Type1(){
		...
		private class Rule_hyper_2 extends Rule {
				...
				Rule_hyper_2 (){
					...
					addEffect(Effect.PERMIT);
					//Target
					addTarget(new ExpressionBooleanTree(ExprBooleanConnector.AND,new ExpressionBooleanTree(new ExpressionFunction(new it.unifi.facpl.lib.function.comparison.LessThanOrEqual(), 1,new AttributeName("system","hyper2.availableResources") 
