	...
	public PolicySet_SLA_Type2(){
		...
		private class Rule_hyper_2_create extends Rule {
				...
				Rule_hyper_2_create (){
					...
					addEffect(Effect.PERMIT);
					//Target
					addTarget(new ExpressionBooleanTree(ExprBooleanConnector.AND,new ExpressionBooleanTree(new ExpressionFunction(new it.unifi.facpl.lib.function.comparison.LessThanOrEqual(), 2,new AttributeName("system","hyper2.availableResources") 
