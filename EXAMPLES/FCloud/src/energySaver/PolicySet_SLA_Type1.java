	...
	public PolicySet_SLA_Type1(){
		...
		private class Rule_hyper_1 extends Rule {
				...
				Rule_hyper_1 (){
					...
					//Target
					addTarget(new ExpressionFunction(it.unifi.facpl.lib.function.comparison.LessThanOrEqual.class, 1,new AttributeName("system","hyper1.availableResources") 
					)
					);
					//Obligations
		...
		private class Rule_hyper_2 extends Rule {
				...
				Rule_hyper_2 (){
					...
					addEffect(Effect.PERMIT);
					//Target
					addTarget(new ExpressionFunction(it.unifi.facpl.lib.function.comparison.LessThanOrEqual.class, 1,new AttributeName("system","hyper2.availableResources") 
					)
					);
					//Obligations
