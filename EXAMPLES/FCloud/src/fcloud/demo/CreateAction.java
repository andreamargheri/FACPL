	...
	public void eval(List<Object> args) throws Throwable {
		...
		try {
			...
			if (args.get(2).equals("TYPE_1"))
				...
				n = 2;
			prop.setProperty("VM_"+args.get(2)+"s", Integer.toString(Integer.parseInt(prop.getProperty("VM_"+args.get(2)+"s")) + 1));
			...
			prop.store(new FileOutputStream(
					new File(absPath + File.separator + args.get(0) + ".properties")), "Add new VM");
